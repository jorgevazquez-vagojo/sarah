...
const SETTING_CATEGORIES: { id: SettingsCategory; label: string; icon: string }[] = [
  ...
  { id: 'pbx', label: 'SIP/SarahPhone', icon: 'M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72' },
  { id: 'extensions', label: 'SarahPhone', icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2' },
    ...
    <div className="animate-fade-in">
      ...
      {category === 'pbx' && (
        <div className="rounded-2xl p-5" style={{ background: 'var(--rd-surface)', border: '1px solid var(--rd-border)' }}>
          ...
          <p className="text-xs mb-5" style={{ color: 'var(--rd-text-muted)' }}>Conexion SIP a la centralita cloud (Vozelia, 3CX, Asterisk) para SarahPhone</p>
          <div className="grid grid-cols-2 gap-3">
      ...
      {/* SarahPhone Extensions */}
      {category === 'extensions' && (
        <div className="rounded-2xl p-5" style={{ background: 'var(--rd-surface)', border: '1px solid var(--rd-border)' }}>
          <h3 className="text-sm font-bold mb-1" style={{ color: 'var(--rd-text)' }}>SarahPhone — Extensiones de agentes</h3>
